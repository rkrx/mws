 ...
 */
 ...
 class MWSMerchantFulfillmentService_Model_PackageDimensions extends MWSMerchantFulfillmentService_Model {
     ...
     *
     * @return bool if PredefinedPackageDimensions is set.
     */
