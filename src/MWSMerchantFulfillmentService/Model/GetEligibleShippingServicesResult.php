 ...
 */
 ...
 class MWSMerchantFulfillmentService_Model_GetEligibleShippingServicesResult extends MWSMerchantFulfillmentService_Model {
     ...
     *
     * @return bool if ShippingServiceList is set.
     */
     ...
     *
     * @return bool if TemporarilyUnavailableCarrierList is set.
     */
     ...
     *
     * @return bool if TermsAndConditionsNotAcceptedCarrierList is set.
     */
