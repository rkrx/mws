 ...
 */
 ...
 class MWSMerchantFulfillmentService_Model_ShippingService extends MWSMerchantFulfillmentService_Model {
     ...
     *
     * @return bool if ShippingServiceName is set.
     */
     ...
     *
     * @return bool if ShippingServiceId is set.
     */
     ...
     *
     * @return bool if ShippingServiceOfferId is set.
     */
     ...
     *
     * @return bool if EarliestEstimatedDeliveryDate is set.
     */
     ...
     *
     * @return bool if LatestEstimatedDeliveryDate is set.
     */
     ...
     *
     * @return bool if ShippingServiceOptions is set.
     */
