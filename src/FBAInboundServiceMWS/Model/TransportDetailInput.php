...
class FBAInboundServiceMWS_Model_TransportDetailInput extends FBAInboundServiceMWS_Model
{
     ...
     *
     * @return bool if PartneredSmallParcelData is set.
     */
     ...
     *
     * @return bool if NonPartneredSmallParcelData is set.
     */
     ...
     *
     * @return bool if PartneredLtlData is set.
     */
     ...
     *
     * @return bool if NonPartneredLtlData is set.
     */
