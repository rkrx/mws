...
class FBAInboundServiceMWS_Model_ListInboundShipmentsRequest extends FBAInboundServiceMWS_Model
{
     ...
     *
     * @return bool if ShipmentStatusList is set.
     */
     ...
     *
     * @return bool if ShipmentIdList is set.
     */
     ...
     *
     * @return bool if LastUpdatedBefore is set.
     */
     ...
     *
     * @return bool if LastUpdatedAfter is set.
     */
