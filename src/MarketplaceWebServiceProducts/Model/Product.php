...
class MarketplaceWebServiceProducts_Model_Product extends MarketplaceWebServiceProducts_Model
{
     ...
     *
     * @return bool if Identifiers is set.
     */
     ...
     *
     * @return bool if AttributeSets is set.
     */
     ...
     *
     * @return bool if Relationships is set.
     */
     ...
     *
     * @return bool if CompetitivePricing is set.
     */
     ...
     *
     * @return bool if SalesRankings is set.
     */
     ...
     *
     * @return bool if LowestOfferListings is set.
     */
