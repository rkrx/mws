 ...
 */
 ...
 class MWSRecommendationsSectionService_Model_InventoryRecommendation extends MWSRecommendationsSectionService_Model {
     ...
     *
     * @return bool if SalesForTheLast14Days is set.
     */
     ...
     *
     * @return bool if SalesForTheLast30Days is set.
     */
     ...
     *
     * @return bool if AvailableQuantity is set.
     */
     ...
     *
     * @return bool if DaysUntilStockRunsOut is set.
     */
     ...
     *
     * @return bool if InboundQuantity is set.
     */
     ...
     *
     * @return bool if RecommendedInboundQuantity is set.
     */
     ...
     *
     * @return bool if DaysOutOfStockLast30Days is set.
     */
     ...
     *
     * @return bool if LostSalesInLast30Days is set.
     */
