...
class MarketplaceWebServiceOrders_Client implements MarketplaceWebServiceOrders_Interface
{
	 ...
	 * @param string|int $applicationVersion
    ...
    private function constructUserAgentHeader($applicationName, $applicationVersion, $attributes = null)
    {
        ...
        $userAgent .= '; ';
        $userAgent .= 'Platform=' . PHP_OS . '/' . php_uname('m') . '/' . php_uname('r');
        $userAgent .= '; ';
    ...
    private function _sign($data, $key, $algorithm)
    {
        if ($algorithm === 'HmacSHA1') {
            ...
            throw new RuntimeException('Non-supported signing method specified');
        }
