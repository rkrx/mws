 ...
 */
 ...
 class MWSFinancesService_Model_PayWithAmazonEvent extends MWSFinancesService_Model {
     ...
     *
     * @return bool if TransactionPostedDate is set.
     */
     ...
     *
     * @return bool if BusinessObjectType is set.
     */
     ...
     *
     * @return bool if SalesChannel is set.
     */
     ...
     *
     * @return bool if PaymentAmountType is set.
     */
     ...
     *
     * @return bool if AmountDescription is set.
     */
     ...
     *
     * @return bool if StoreName is set.
     */
