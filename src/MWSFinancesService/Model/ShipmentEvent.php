 ...
 */
 ...
 class MWSFinancesService_Model_ShipmentEvent extends MWSFinancesService_Model {
     ...
     *
     * @return bool if AmazonOrderId is set.
     */
     ...
     *
     * @return bool if SellerOrderId is set.
     */
     ...
     *
     * @return bool if MarketplaceName is set.
     */
     ...
     *
     * @return bool if OrderChargeList is set.
     */
     ...
     *
     * @return bool if OrderChargeAdjustmentList is set.
     */
     ...
     *
     * @return bool if ShipmentFeeList is set.
     */
     ...
     *
     * @return bool if ShipmentFeeAdjustmentList is set.
     */
     ...
     *
     * @return bool if OrderFeeList is set.
     */
     ...
     *
     * @return bool if OrderFeeAdjustmentList is set.
     */
     ...
     *
     * @return bool if DirectPaymentList is set.
     */
     ...
     *
     * @return bool if PostedDate is set.
     */
     ...
     *
     * @return bool if ShipmentItemList is set.
     */
     ...
     *
     * @return bool if ShipmentItemAdjustmentList is set.
     */
