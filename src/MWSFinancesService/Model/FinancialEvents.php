 ...
 */
 ...
 class MWSFinancesService_Model_FinancialEvents extends MWSFinancesService_Model {
     ...
     *
     * @return bool if ShipmentEventList is set.
     */
     ...
     *
     * @return bool if RefundEventList is set.
     */
     ...
     *
     * @return bool if GuaranteeClaimEventList is set.
     */
     ...
     *
     * @return bool if ChargebackEventList is set.
     */
     ...
     *
     * @return bool if PayWithAmazonEventList is set.
     */
     ...
     *
     * @return bool if ServiceProviderCreditEventList is set.
     */
     ...
     *
     * @return bool if RetrochargeEventList is set.
     */
     ...
     *
     * @return bool if RentalTransactionEventList is set.
     */
     ...
     *
     * @return bool if PerformanceBondRefundEventList is set.
     */
     ...
     *
     * @return bool if ServiceFeeEventList is set.
     */
     ...
     *
     * @return bool if DebtRecoveryEventList is set.
     */
     ...
     *
     * @return bool if LoanServicingEventList is set.
     */
     ...
     *
     * @return bool if AdjustmentEventList is set.
     */
