 ...
 */
 ...
 class MWSFinancesService_Model_SolutionProviderCreditEvent extends MWSFinancesService_Model {
     ...
     *
     * @return bool if ProviderTransactionType is set.
     */
     ...
     *
     * @return bool if MarketplaceCountryCode is set.
     */
     ...
     *
     * @return bool if SellerStoreName is set.
     */
     ...
     *
     * @return bool if ProviderId is set.
     */
     ...
     *
     * @return bool if ProviderStoreName is set.
     */
