 ...
 */
 ...
 class MWSFinancesService_Model_DebtRecoveryEvent extends MWSFinancesService_Model {
     ...
     *
     * @return bool if DebtRecoveryType is set.
     */
     ...
     *
     * @return bool if OverPaymentCredit is set.
     */
     ...
     *
     * @return bool if DebtRecoveryItemList is set.
     */
     ...
     *
     * @return bool if ChargeInstrumentList is set.
     */
