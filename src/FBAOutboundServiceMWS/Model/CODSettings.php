...
class FBAOutboundServiceMWS_Model_CODSettings extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if IsCODRequired is set to true.
     */
     ...
     *
     * @return bool if IsCODRequired is set.
     */
     ...
     *
     * @return bool if CODCharge is set.
     */
     ...
     *
     * @return bool if CODChargeTax is set.
     */
     ...
     *
     * @return bool if ShippingCharge is set.
     */
     ...
     *
     * @return bool if ShippingChargeTax is set.
     */
