...
class FBAOutboundServiceMWS_Model_FulfillmentPreviewShipment extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if EarliestShipDate is set.
     */
     ...
     *
     * @return bool if LatestShipDate is set.
     */
     ...
     *
     * @return bool if EarliestArrivalDate is set.
     */
     ...
     *
     * @return bool if LatestArrivalDate is set.
     */
     ...
     *
     * @return bool if FulfillmentPreviewItems is set.
     */
