...
class FBAOutboundServiceMWS_Model_GetFulfillmentPreviewRequest extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if ShippingSpeedCategories is set.
     */
     ...
     *
     * @return bool if IncludeCODFulfillmentPreview is set to true.
     */
     ...
     *
     * @return bool if IncludeCODFulfillmentPreview is set.
     */
     ...
     *
     * @return bool if IncludeDeliveryWindows is set to true.
     */
     ...
     *
     * @return bool if IncludeDeliveryWindows is set.
     */
