...
class FBAOutboundServiceMWS_Model_FulfillmentPreview extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if ScheduledDeliveryInfo is set.
     */
     ...
     *
     * @return bool if IsFulfillable is set to true.
     */
     ...
     *
     * @return bool if IsFulfillable is set.
     */
     ...
     *
     * @return bool if IsCODCapable is set to true.
     */
     ...
     *
     * @return bool if IsCODCapable is set.
     */
     ...
     *
     * @return bool if EstimatedShippingWeight is set.
     */
     ...
     *
     * @return bool if EstimatedFees is set.
     */
     ...
     *
     * @return bool if FulfillmentPreviewShipments is set.
     */
     ...
     *
     * @return bool if UnfulfillablePreviewItems is set.
     */
     ...
     *
     * @return bool if OrderUnfulfillableReasons is set.
     */
