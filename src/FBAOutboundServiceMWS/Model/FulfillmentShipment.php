...
class FBAOutboundServiceMWS_Model_FulfillmentShipment extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if AmazonShipmentId is set.
     */
     ...
     *
     * @return bool if FulfillmentCenterId is set.
     */
     ...
     *
     * @return bool if FulfillmentShipmentStatus is set.
     */
     ...
     *
     * @return bool if ShippingDateTime is set.
     */
     ...
     *
     * @return bool if FulfillmentShipmentItem is set.
     */
     ...
     *
     * @return bool if FulfillmentShipmentPackage is set.
     */
