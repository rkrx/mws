...
class FBAOutboundServiceMWS_Model_FulfillmentOrder extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if SellerFulfillmentOrderId is set.
     */
     ...
     *
     * @return bool if DisplayableOrderId is set.
     */
     ...
     *
     * @return bool if DisplayableOrderDateTime is set.
     */
     ...
     *
     * @return bool if DisplayableOrderComment is set.
     */
     ...
     *
     * @return bool if ShippingSpeedCategory is set.
     */
     ...
     *
     * @return bool if DeliveryWindow is set.
     */
     ...
     *
     * @return bool if DestinationAddress is set.
     */
     ...
     *
     * @return bool if FulfillmentPolicy is set.
     */
     ...
     *
     * @return bool if FulfillmentMethod is set.
     */
     ...
     *
     * @return bool if CODSettings is set.
     */
     ...
     *
     * @return bool if ReceivedDateTime is set.
     */
     ...
     *
     * @return bool if FulfillmentOrderStatus is set.
     */
     ...
     *
     * @return bool if StatusUpdatedDateTime is set.
     */
     ...
     *
     * @return bool if NotificationEmailList is set.
     */
