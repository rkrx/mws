...
class FBAOutboundServiceMWS_Model_FulfillmentOrderItem extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if GiftMessage is set.
     */
     ...
     *
     * @return bool if DisplayableComment is set.
     */
     ...
     *
     * @return bool if FulfillmentNetworkSKU is set.
     */
     ...
     *
     * @return bool if OrderItemDisposition is set.
     */
     ...
     *
     * @return bool if CancelledQuantity is set.
     */
     ...
     *
     * @return bool if UnfulfillableQuantity is set.
     */
     ...
     *
     * @return bool if EstimatedShipDateTime is set.
     */
     ...
     *
     * @return bool if EstimatedArrivalDateTime is set.
     */
     ...
     *
     * @return bool if PerUnitPrice is set.
     */
     ...
     *
     * @return bool if PerUnitTax is set.
     */
     ...
     *
     * @return bool if PerUnitDeclaredValue is set.
     */
