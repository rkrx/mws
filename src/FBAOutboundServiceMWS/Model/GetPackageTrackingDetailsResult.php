...
class FBAOutboundServiceMWS_Model_GetPackageTrackingDetailsResult extends FBAOutboundServiceMWS_Model
{
     ...
     *
     * @return bool if TrackingNumber is set.
     */
     ...
     *
     * @return bool if CarrierCode is set.
     */
     ...
     *
     * @return bool if CarrierPhoneNumber is set.
     */
     ...
     *
     * @return bool if CarrierURL is set.
     */
     ...
     *
     * @return bool if ShipDate is set.
     */
     ...
     *
     * @return bool if EstimatedArrivalDate is set.
     */
     ...
     *
     * @return bool if ShipToAddress is set.
     */
     ...
     *
     * @return bool if CurrentStatus is set.
     */
     ...
     *
     * @return bool if SignedForBy is set.
     */
     ...
     *
     * @return bool if AdditionalLocationInfo is set.
     */
     ...
     *
     * @return bool if TrackingEvents is set.
     */
